...
\nt{All entries of a classical probabilistic vector are nonnegative real numbers and sum to 1.}
...
\begin{note}
    The order is important: matrix multiplication is \textbf{not} commutative.
\end{note}
